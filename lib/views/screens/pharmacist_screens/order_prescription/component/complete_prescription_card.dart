...
class PharmacistCompletePrescriptionCardWidget extends StatefulWidget {
  const PharmacistCompletePrescriptionCardWidget(
      {super.key,
  ...
  @override
  State<PharmacistCompletePrescriptionCardWidget> createState() => _PrescriptionCardWidgetState();
}

class _PrescriptionCardWidgetState extends State<PharmacistCompletePrescriptionCardWidget> {
  @override
